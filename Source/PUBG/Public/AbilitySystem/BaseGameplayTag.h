...
namespace BaseGameplayTag
{
	...
	PUBG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Pistol);
	PUBG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SR);
	PUBG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SG);
	PUBG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_DMR);
	PUBG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SMG);
